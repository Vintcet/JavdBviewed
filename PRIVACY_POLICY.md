...
My JavDB（以下简称"本扩展"）尊重并保护用户的隐私。本隐私政策说明了本扩展如何收集、使用、存储和保护您的信息。

### 2. 开发者信息

- **扩展名称**: My JavDB
- **开发者**: Adsryen
- **联系方式**: [GitHub Issues](https://github.com/Vintcet/my-javdb/issues)
...
- **GitHub Discussions**: https://github.com/Vintcet/my-javdb/discussions
...
- **Developer**: Adsryen
- **Contact**: [GitHub Issues](https://github.com/Vintcet/my-javdb/issues)
...
**注意 / Note**: 本隐私政策适用于 My JavDB浏览器扩展。使用本扩展即表示您同意本隐私政策的条款。
